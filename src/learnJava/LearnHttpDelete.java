...
public class LearnHttpDelete {
	
	public static void main(String[] arg) throws JsonGenerationException, JsonMappingException, IOException {  
		 String exampleUrl = "http://openam.example.com:8080/openam/json/users/user13";
		String param = "AQIC5wM2LY4SfcyQhSqhuA5Q3Cf8S9ruqAwLctxkgDU5AbA.*AAJTSQACMDEAAlNLABMxNjQ0OTg1OTY1NjAwMTA2NDI4AAJTMQAA*";
//		String data = "{'username': 'user8','userpassword': 'password','employeeNumber':'employeeNumbertest'}";
		Map<String, String> data = new HashMap<String, String>();
		data.put("username", "user10");
